...
export const Button = (props) => {
    const { btnType, children, size, disabled, href, className } = props, restProps = __rest(props, ["btnType", "children", "size", "disabled", "href", "className"]);
    ...
    if (btnType === ButtonType.Link && href) {
        return React.createElement("a", Object.assign({ className: classes, href: href }, restProps, { target: "_blank" }), children);
    }
